...
Keypoint detection — DeepLabCut-based pose estimation with region partitioning and color transformation preprocessing
LOE classification — ResNet34-based frame classification combined with keypoint coordinates, followed by time-series post-processing
